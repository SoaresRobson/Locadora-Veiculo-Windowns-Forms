...
{
    //Essa classe contém alguns métodos para criptografia de uma string.
    //Esses métodos utilizam classes da biblioteca do C# para realizar
    //as operações de criptografia.
